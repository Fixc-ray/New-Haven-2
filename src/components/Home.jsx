      ...
      for (let i = 0; i < friends.length; i++) {
        timers.push(setTimeout(() => {
          ...
          if (i === friends.length - 1) {
            timers.push(setTimeout(() => deleteFriends(), 3000));
          }
        }, i * 400));
      }
    };
    ...
    const deleteFriends = () => {
      ...
      for (let i = friends.length - 1; i >= 0; i--) {
        timers.push(setTimeout(() => {
          ...
          if (i === 0) {
            timers.push(setTimeout(() => spellFamily(), 1000));
          }
      ...
      for (let i = 0; i < family.length; i++) {
        timers.push(setTimeout(() => {
          ...
          if (i === family.length - 1) {
            timers.push(setTimeout(() => deleteFamily(), 3000));
          }
        }, i * 500));
      }
    };
    ...
    const deleteFamily = () => {
      ...
      for (let i = family.length - 1; i >= 0; i--) {
        timers.push(setTimeout(() => {
          ...
          if (i === 0) {
            timers.push(setTimeout(() => spellFriends(), 1000));
          }
        }, (family.length - i) * 200));
      }
    };
    ...
    <div className="home">
      ...
      <div className="relative w-full h-[80vh]">
        ...
        <h1 className="absolute top-[30%] left-1/2 transform -translate-x-1/2 text-2xl sm:text-3xl md:text-6xl font-bold mt-20 pt-6 text-center text-white">
          Dine With <span className="text-orange-500">{friendsText}{familyText}</span>
        </h1>
